---
title: "TMDB API Integration in Pelisgo"
sidebarTitle: "TMDB API"
description: "How Pelisgo authenticates with and queries the TMDB v3 REST API — endpoints used, response shapes consumed, and the browser-native fetch() implementation."
---
