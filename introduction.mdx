---
title: "Pelisgo: Movie & Series Browser Built on TMDB"
...
Pelisgo intentionally keeps its footprint as small as possible. The entire project is two HTML pages, one shared JavaScript module, and one stylesheet:
...
| Layer | Choice | Notes |
|---|---|---|
| Markup | Plain HTML5 | Two `.html` files; no templating engine |
